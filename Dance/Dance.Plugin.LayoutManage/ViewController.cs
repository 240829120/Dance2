...
namespace Dance.Plugin.LayoutManage
{
    ...
    public class ViewController
    {
        ...
        {
            DanceDomain.Current.Messenger.Register<DanceMainWindowLoadedMessage>(this, this.DanceMainWindowLoaded);
        }
        ...
        private void DanceMainWindowLoaded(object sender, DanceMainWindowLoadedMessage msg)
        {
